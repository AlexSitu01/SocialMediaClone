...
import { PostInfo, timeDifference } from "./Post";
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                ...
                <DialogPanel className="rounded-sm bg-white shadow-lg flex flex-col md:flex-row">
                    ...
                    <div className="flex flex-col w-full md:w-[60vh] md:h-[90vh]">
                        ...
                        {/* Comments */}
                        <div className="h-[73%] pl-3 border-b-1 border-gray-200 pr-3 overflow-y-scroll overflow-x-hidden">
                            {/* change content to be dynamic later on taking, using the comment in the postInfo object */}
                            <Comment id={1} content="The birds chirping & ocean waves playing as the credits rolled was an incredible touch at the end as well" author={postInfo.author} likeCount={2} timeOfComment={1741942016898} isDescription={true}></Comment>
                            <Comment id={1} content="The birds chirping & ocean waves playing as the credits rolled was an incredible touch at the end as well" author={postInfo.author} likeCount={2} timeOfComment={1741942016898}></Comment>
                            <Comment id={1} content="The birds chirping & ocean waves playing as the credits rolled was an incredible touch at the end as well" author={postInfo.author} likeCount={2} timeOfComment={1741942016898}></Comment>
                            <Comment id={1} content="The birds chirping & ocean waves playing as the credits rolled was an incredible touch at the end as well" author={postInfo.author} likeCount={2} timeOfComment={1741942016898}></Comment>
                            <Comment id={1} content="The birds chirping & ocean waves playing as the credits rolled was an incredible touch at the end as well" author={postInfo.author} likeCount={2} timeOfComment={1741942016898}></Comment>
                            <Comment id={1} content="The birds chirping & ocean waves playing as the credits rolled was an incredible touch at the end as well" author={postInfo.author} likeCount={2} timeOfComment={1741942016898}></Comment>
