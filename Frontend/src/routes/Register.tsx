...
export function Register() {
    ...
    const handleLoginError = () => {
        if (loginError === "EMPTY_FIELD") {
            ...
            return ("That account alredy exists")
        }
            ...
            <form onSubmit={handleRegister}>
                <div className="flex flex-col justify-center items-center w-screen h-screen">
                    <div className="flex flex-col justify-center items-center space-y-2 w-[40%] h-[80%] bg-gradient-to-tr from-indigo-200 to-red-200 rounded-3xl">
                        ...
                        <button type="button" onClick={() => navigation("/login")} className="cursor-pointer text-blue-300">Already have an account?</button>
                        <button type="submit" className="cursor-pointer rounded-xl p-2 font-semibold bg-blue-500 text-white" disabled={isLoading}>{isLoading ?
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
