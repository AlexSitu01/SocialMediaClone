...
export function Login() {
    ...
    const [loginError, setLoginError] = useState<"EMPTY_FIELD" | "WRONG_PASS" | "GOOGLE_LOGIN_ERR" | undefined>()
    ...
    const handleLoginWithGoogle = async () => {
        try {
            ...
            setLoginError("GOOGLE_LOGIN_ERR")
        }
        finally {
            setIsLoading(false)
        }
    ...
    const handleLoginError = () => {
        ...
        else if (loginError === "GOOGLE_LOGIN_ERR") {
            return ("There was an issue logging in with Google")
        }
        return
    }
            ...
            <form onSubmit={handleLogin}>
                <div className="flex flex-col justify-center items-center w-screen h-screen">
                    <div className="flex flex-col justify-center items-center space-y-2 w-[40%] h-[80%] bg-gradient-to-tr from-indigo-200 to-red-200 rounded-3xl">
                        ...
                        <button type="button" disabled={isLoading} onClick={handleLoginWithGoogle} className="mt-4 flex items-center bg-white dark:bg-gray-900 border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
